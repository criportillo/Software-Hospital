...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2015 a las 07:55:45
...
(4, 1, 'Cerrar Sesion', '', '2015-04-07', '2015-04-07', 1),
...
(10, 2, 'Roll', 'wfRoll', '2015-04-08', '2015-04-08', 1),
(11, 1, 'Salir', '', '2015-04-08', '2015-04-08', 1);
...
--
ALTER TABLE `detalle_modulo`
MODIFY `id_detmod` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `sub_modulo`
MODIFY `id_submodulo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
