...
namespace dll_seguridad.Multilenguaje {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class StringResources : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(StringResources).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(StringResources));
        ...
        private string FindResource() {
            string[] resources = typeof(StringResources).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".StringResources.g.xaml") || resource.Equals("StringResources.g.xaml"))) {
                    return resource;
                }
            }
