...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2015 a las 06:24:12
...
INSERT INTO `detalle_modulo` (`id_detmodulo`, `codigo_perfil`, `id_modulo`, `fecha_creacion`, `fecha_modificacion`, `estado`) VALUES
('1', '1', '1', '15-04-2015', '15-04-2015', '1'),
('2', '1', '2', '15-04-2015', '15-04-2015', '1');
...
CREATE TABLE IF NOT EXISTS `paciente` (
  ...
  `estatura_paciente` decimal(10,0) NOT NULL,
  `peso_paciente` decimal(10,0) NOT NULL,
  `sangre_paciente` varchar(5) NOT NULL,
  `identificacion_paciente` decimal(10,0) NOT NULL,
