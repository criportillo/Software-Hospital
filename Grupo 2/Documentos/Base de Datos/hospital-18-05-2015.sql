...
CREATE TABLE inventario (
                ...
                CONSTRAINT inventario_pk PRIMARY KEY (id_inven)
);
...
ALTER TABLE det_fact ADD CONSTRAINT inventario_det_fact_fk
FOREIGN KEY (id_inven)
REFERENCES inventario (id_inven)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
INSERT INTO sub_modulo (id_submodulo, id_modulo, nombre_submodulo, nombre_form, fecha_creacion, fecha_modificacion, estado) VALUES (13,4,'Antecedentes Médicos','wfAntecedentesM2','15/05/2015','15/05/2015',1);
